...
export const productRouter = t.router({
  fetchProducts: t.procedure.query(async ({ ctx }) => {
  ...
  addProducts: t.procedure.query(async ({ ctx }) => {
    // await Promise.all(
    ...
    //       await Promise.all(
    //         p.sizes.map(async s => {
    //           await ctx.prisma.sizeByProduct.create({
    //             data: {
    ...
    //           await ctx.prisma.colorByProduct.create({
    //             data: {
    //               productId: newProduct.id,
    //               name: c,
    //             },
